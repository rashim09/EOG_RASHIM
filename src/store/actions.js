...
export const FETCHDRONE_WEATHER = "COMMAND/FETCHDRONE_WEATHER";
export const FETCHDRONE_WEATHER_RECEIVED = "EVENT/FETCHDRONE_WEATHER_RECEIVED";
// export const FETCHDRONE _WEATHER = "COMMAND/FETCH_WEATHER_FOR_LAT_LNG";
